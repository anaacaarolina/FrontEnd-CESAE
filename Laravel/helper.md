...
- `composer create-project Laravel/Laravel ServerSideSD`
...
- `php artisan make:migration create_tasks_table` (cria a migração)
...
`non writable`: apagar a cache e reescrever
